...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> BLOCKBREAK_SOUND = SOUND_EVENTS.register("blockbreak", 
        () -> new SoundEvent(new ResourceLocation(MainMod.MODID, "blockbreak")));
